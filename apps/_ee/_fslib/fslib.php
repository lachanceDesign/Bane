	...
	$pathDis = $path.''.$display;
		...
		global $filePages;
			...
			if (in_array(strtolower($type), $previewFiles)) {
				...
				<a href='javascript:void(0);' rel='".$display."".$file."' class='modalImage'><img src='$filePages/res/zoom.png' alt='Preview File' title='Preview File' /></a>";
			}else{
...
&nbsp;&nbsp;&nbsp;<a href='javascript:void(0)' id='fileUpload' title='Upload File/s' ><img src='$filePages/res/page_add.png' alt='Upload File/s' /> Upload File/s </a>
...
<div id='uploadFile' style='display:none;'><div class='inner'> <img src='$filePages/res/cancel.png' title='Close Window' alt='Close Window' id='cancelFile'/>
						...
						<div id='flashTarget'>
							<fieldset class='flash' id='fsUploadProgress'>
								<legend>Uploaded File/s</legend><p>Upload limit of 12 items at a time, with a maximum upload size of 10mb per file.</p>
							<div class='btnholder'>
								...
								<br/>
								<em>Use shift left click to select multiple files.</em><br />
							</div>
...
<div id='fslibDialog'><a class='modalCloseImg simplemodal-close' title='Close'></a>
