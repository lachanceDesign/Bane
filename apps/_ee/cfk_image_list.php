        ...
        $fileData .= '
             <div>
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-6">
                               <h5 class="text-muted">
                                   <strong>Image Name:</strong> '. str_replace($eeIpath,'',$val).'
                                   <p>
                                       <br><br><br>
                                   <strong>Preview Image:</strong><br>
                                       <a target="_blank" href="'.$val.'">
                                       '.$_SERVER['SERVER_NAME'].$val.'
                                       </a>
                                   </p>
                               </h5>
                   </div>
...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            /*##### START: HTML Main #####*/
            body {  font: 62.5% "Century Gothic", Geneva, Verdana, Arial, Helvetica, sans-serif; color: #4C1803;padding:90px 10px 10px;}
