<!-- Open Carousel -->
    <?php 
      ...
      <div style="text-align:center;" class="carousel-inner" role="listbox">
        <div class="item active">
          <img width="1140" height="400" class="first-slide" src="http://static.banecare.com/images/slides/BaneCare-Home-Slider1.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img width="1140" height="400" class="second-slide" src="http://static.banecare.com/images/slides/BaneCare-Home-Slider2.jpg" alt="Second slide">
          <div class="container">
            <!--<div class="carousel-caption">
        ...
        <div class="item">
          <img width="1140" height="400" class="third-slide" src="http://static.banecare.com/images/slides/BaneCare-Home-Slider3.jpg" alt="Third slide">
          <div class="container">
            <!--<div class="carousel-caption">
        ...
        <div class="item">
          <img width="1140" height="400" class="third-slide" src="http://static.banecare.com/images/slides/BaneCare-Home-Slider5.jpg" alt="Third slide">
          <div class="container">
            <!--<div class="carousel-caption">
              <h1>One more for good measure.</h1>
              <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
    ...
    ';
  }else if(file_exists('images/slides/banecare-'.title(2).'.jpg')){
                 echo '
<header>
    <div class="container">
        <div class="row">
        <img width="1200" height="400" src="http://static.banecare.com/images/slides/banecare-'.title(2).'.jpg">
        </div>
    </div>
</header>
...
<header>
    <div class="container">
        <div class="row">
        <img width="1200" height="400" src="http://static.banecare.com/images/slides/'.title(2).'-skilled-nursing-slider.jpg">
        </div>
    </div>
</header>
