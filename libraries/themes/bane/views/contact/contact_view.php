            ...
            <div class="row">
                ...
                ?>
                    ...
                    <div class="col-md-9">
                        ...
                        <br>
                        <?php echo $msg1; ?>
                            <form method="post" id="schedule3" action="" style="text-align:left;width:80%;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="phone" type="text" required class="form-control" id="phone" />
                                </div>
                                ...
                                <?php echo $captcha; ?>
                                    ...
                                    <input class="btn btn-warning" type="submit" name="contactF" value="Submit" />
