    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <h1 class="fancy"><?php echo implode(' ', explode('-',title(2))); if(title(2) == 'Sugar-Hill'){ echo ' Assisted Living Community'; }else{ echo ' Skilled Nursing'; }; ?> Leadership</h1>
                
            <hr>
                
                <div class="e-ease ee:wwig" id="_<?php echo 'leader_'.title(2).''; ?>">
                    <?php 

                      newEE('leader_'.title(2).'');
