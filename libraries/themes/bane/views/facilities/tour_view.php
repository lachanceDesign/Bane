    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <h1 class="fancy"><?php echo implode(' ', explode('-',title(2))); if(title(2) == 'Sugar-Hill'){ echo ' Assisted Living Community'; }else{ echo ' Skilled Nursing'; }; ?> Virtual Tours</h1>

                <hr>

                <div class="e-ease ee:wwig" id="_<?php echo 'tour_'.title(2).''; ?>">
                    <?php 
