...
?>
    ...
    <button class="waves-effect waves-red btn modal-trigger blue" href="#addPage" class="btn modal-trigger">Add new page</button>
    <br/>
    <br/>
    ...
    <?php 
						...
						if(isset($_POST[''.$method.''])){
							...
							if(isset($_POST['id'])){
								...
								$script = substr(addslashes($_POST['script']),0,120);
