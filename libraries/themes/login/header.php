...
<body>
    ...
    <!--Open Nav-Sidebar-->
    <nav style="position:relative;" class="#00838f cyan darken-0 light">
        ...
        <ul id="slide-out" class="#424242 grey darken-3 side-nav fixed">
            ...
            <li><a class="white-text  waves-effect waves-red" href="<?php echo ROOT; ?>tp-Jobs"><i class="material-icons left">business</i>New Job</a></li>
            <li><a href="tp-login" class="white-text  waves-effect waves-red" onclick="eelogout();"><i class="material-icons left">power_settings_new</i>Logout</a></li>
            </ul>
    </nav>
    <!--Close Nav-Sidebar-->
